/* =============== PRODUCT DATA =============== */
const PRODUCTS = [
  { id: 1,  name: 'Strawberry Shortcake',      price: 15.99, category: 'strawberry', tag: 'Bestseller', desc: 'Light sponge with fresh strawberries and whipped cream.',            img: 'product-strawberry-1.png' },
  { id: 2,  name: 'Fresh Strawberry Delight',  price: 17.99, category: 'strawberry', tag: 'New',        desc: 'Double layer with strawberry compote and mascarpone.',              img: 'product-strawberry-2.png' },
  { id: 3,  name: 'Strawberry Rose Cake',       price: 19.99, category: 'strawberry', tag: 'Premium',   desc: 'Elegant rose-shaped decoration with strawberry mousse.',            img: 'product-strawberry-3.png' },
  { id: 4,  name: 'Classic Vanilla Bean',       price: 15.99, category: 'vanilla',    tag: 'Classic',   desc: 'Rich Madagascar vanilla bean with buttercream frosting.',           img: 'product-vanilla-1.png' },
  { id: 5,  name: 'Vanilla Buttercream',        price: 16.99, category: 'vanilla',    tag: 'Popular',   desc: 'Ultra-smooth buttercream with vanilla pastry cream filling.',       img: 'product-vanilla-2.png' },
  { id: 6,  name: 'Soft Vanilla Sponge',        price: 14.99, category: 'vanilla',    tag: 'Light',     desc: 'Airy chiffon sponge with vanilla cream and fresh flowers.',         img: 'product-vanilla-3.png' },
  { id: 7,  name: 'Chocolate Fudge Cake',       price: 18.99, category: 'chocolate',  tag: 'Bestseller',desc: 'Triple-layered dark chocolate with fudge ganache.',                 img: 'product-chocolate-1.png' },
  { id: 8,  name: 'Dark Velvet Cake',           price: 20.99, category: 'chocolate',  tag: 'Premium',   desc: 'Deep dark chocolate with velvet crumb and cocoa glaze.',           img: 'product-chocolate-2.png' },
  { id: 9,  name: 'Triple Chocolate',           price: 22.99, category: 'chocolate',  tag: 'Indulgent', desc: 'White, milk, and dark chocolate in every single bite.',             img: 'product-chocolate-3.png' },
  { id: 10, name: 'Peanut Banana Cake',         price: 16.99, category: 'fruit',      tag: 'Nutty',     desc: 'Caramelised banana with roasted peanut butter cream.',             img: 'product-dried-fruit-1.png' },
  { id: 11, name: 'Filled Walnut Cake',         price: 17.99, category: 'fruit',      tag: 'Crunchy',   desc: 'Dense walnut sponge with caramel and walnut praline.',             img: 'product-dried-fruit-2.png' },
  { id: 12, name: 'Glazed Pecan Cake',          price: 19.99, category: 'fruit',      tag: 'Special',   desc: 'Buttery pecan filling with caramel glaze topping.',                img: 'product-dried-fruit-3.png' },
  { id: 13, name: 'Chocolate Brownie',          price: 12.99, category: 'others',     tag: 'Fudgy',     desc: 'Dense fudge brownie with glossy chocolate topping.',               img: 'product-others-1.png' },
  { id: 14, name: 'Cream Cupcake',              price:  8.99, category: 'others',     tag: 'Mini',      desc: 'Fluffy vanilla cupcake with swirled rosette frosting.',             img: 'product-others-2.png' },
  { id: 15, name: 'Lemon Zest Cake',            price: 15.99, category: 'others',     tag: 'Fresh',     desc: 'Tangy lemon curd with cream cheese and lemon glaze.',              img: 'product-others-3.png' },
];
